...
import com.tilly.steven.stlbusarrivals.Model.Path;
...
import com.tilly.steven.stlbusarrivals.Model.TimePrediction;
import com.tilly.steven.stlbusarrivals.Model.Vehicule;
...
public class XmlParser extends Observable{
    ...
    public void readMessages(final String xml)
            throws XmlPullParserException, IOException
    {
        new AsyncTask<Void, Void, Void>() {
            String message = "";
                    ...
                    while (eventType != XmlPullParser.END_DOCUMENT) {
                        if (eventType == XmlPullParser.START_DOCUMENT) {
                            ...
                            if(text != null && !text.isEmpty() && !text.contains("\n")) {
                                message = message.concat(Html.fromHtml(text).toString() + "\n \n");
                            }
                        }
                        eventType = xpp.next();
                    }
